/*:
 * @target MZ
 * @plugindesc Character selection screen FINAL UI FIX v25 (adjustable spacing between windows and portraits)
 *
...
const AGE_X = 520;
const AGE_Y = CLASS_Y + CLASS_H + Number(params.InfoWindowsSpacing || 10);
const AGE_W = 300;
const AGE_H = 58;

const INFO_X = 520;
const INFO_Y = AGE_Y + AGE_H + Number(params.InfoWindowsSpacing || 10);
const INFO_W = 300;
const INFO_H = 212;

const CANCEL_X = 520;
const CANCEL_Y = INFO_Y + INFO_H + 20; // чуть ниже bio
const CANCEL_W = 300;
const CANCEL_H = 58;
