/*:
 * @target MZ
 * @plugindesc Character selection screen FINAL UI FIX v31 (5 characters, movable portraits with negative Y, adjustable sizes)
 *
 ...
 * @text Portrait List Offset Y (can be negative)
 * @type string
 * @default 0
 *
 * @param BustX
...
const PORTRAIT_OFFSET_Y = parseInt(params.PortraitOffsetY || "0", 10);
...
const CHOOSE_W = Number(params.ChooseWindowWidth || Graphics.width - 80);
...
const characters = [
  ...
  { name:"PATRICIA", klass:"EX-CULTIST", age:30, bio:"Renegade, formerly held a high rank in Abimhore. Now a fugitive half-blood.", smallPortrait:"portrait2_small", largePortrait:"portrait2_large", actorId:2 },
  ...
  { name:"YORO", klass:"MAGE", age:22, bio:"Talented in elemental magic. Quick learner.", smallPortrait:"portrait4_small", largePortrait:"portrait4_large", actorId:4 },
  { name:"ALYRA", klass:"SHADOW", age:27, bio:"Stealth operative with unmatched agility.", smallPortrait:"portrait5_small", largePortrait:"portrait5_large", actorId:5 }
];
...
class Scene_CharacterSelect extends Scene_MenuBase {
  ...
  updateSelection() {
    ...
    this._portraitSprites.forEach((sp, i) => sp.opacity = i === this._index ? 255 : 120);
